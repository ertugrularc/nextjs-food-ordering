...
const CustomerItem = ({ imgSrc }) => {
  ...
  return (
    <div className='mt-5 mx-4'>
        <div className="p-6 bg-secondary text-white rounded-[5px] pt-5 ">
      <p className="">
      Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perspiciatis dolore neque est unde alias eius voluptates expedita modi voluptatibus nemo, error tempora quia temporibus? Nam.
      </p>
        <div className='flex flex-col mt-4'>
          <span className='text-lg font-semibold'>Eto Arc</span>
